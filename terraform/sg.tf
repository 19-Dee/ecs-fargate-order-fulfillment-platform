...
resource "aws_vpc_security_group_egress_rule" "allow_alb_to_ecs" {
  security_group_id            = aws_security_group.alb_sg.id
  referenced_security_group_id = aws_security_group.ecs_sg.id
  from_port                    = 8080
  ip_protocol                  = "tcp"
...
resource "aws_vpc_security_group_egress_rule" "allow_alb_to_dashboard" {
  security_group_id            = aws_security_group.alb_sg.id
  referenced_security_group_id = aws_security_group.ecs_sg.id
  from_port                    = 8086
  ip_protocol                  = "tcp"
...
resource "aws_vpc_security_group_ingress_rule" "allow_alb_to_dashboard" {
  security_group_id            = aws_security_group.ecs_sg.id
  referenced_security_group_id = aws_security_group.alb_sg.id
  from_port                    = 8086
  ip_protocol                  = "tcp"
...
resource "aws_vpc_security_group_egress_rule" "allow_ecs_to_ecs" {
  security_group_id            = aws_security_group.ecs_sg.id
  referenced_security_group_id = aws_security_group.ecs_sg.id
  from_port                    = 8081
  ip_protocol                  = "tcp"
